...
<html lang='ja'>
	...
	<c:forEach var="record" items="${serialNoList}">
			<c:if test='${serialNo != record.serial_no }'>
						<a href='shiwake_data_de3_henkou?denpyouId=${su:htmlEscape(denpyouId)}&serialNo=${su:htmlEscape(record.serial_no)}'>${su:htmlEscape(record.serial_no)}（${su:htmlEscape(record.shiwake_status_nm)}）</a>
			</c:if>
			<c:if test='${serialNo == record.serial_no }'>
				...
				<section id='data'>
					...
					<div class='control-group'>
						<label class='control-label'>借方　ユニバーサルフィールド１</label>
						<div class='controls'>
							<input type='text' name='kariUf1Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kariUf1Cd)}'>
							<input type='text' name="kariUf1Name" class='input-xlarge' disabled value='${su:htmlEscape(kariUf1Name)}' <c:if test='${"0" eq hfUfSeigyo.uf1ShiyouFlg or "1" eq hfUfSeigyo.uf1ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kariUf1SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf1ShiyouFlg or "1" eq hfUfSeigyo.uf1ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>借方　ユニバーサルフィールド２</label>
						<div class='controls'>
							<input type='text' name='kariUf2Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kariUf2Cd)}'>
							<input type='text' name="kariUf2Name" class='input-xlarge' disabled value='${su:htmlEscape(kariUf2Name)}' <c:if test='${"0" eq hfUfSeigyo.uf2ShiyouFlg or "1" eq hfUfSeigyo.uf2ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kariUf2SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf2ShiyouFlg or "1" eq hfUfSeigyo.uf2ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>借方　ユニバーサルフィールド３</label>
						<div class='controls'>
							<input type='text' name='kariUf3Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kariUf3Cd)}'>
							<input type='text' name="kariUf3Name" class='input-xlarge' disabled value='${su:htmlEscape(kariUf3Name)}' <c:if test='${"0" eq hfUfSeigyo.uf3ShiyouFlg or "1" eq hfUfSeigyo.uf3ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kariUf3SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf3ShiyouFlg or "1" eq hfUfSeigyo.uf3ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>摘要</label>
						<div class='controls'>
							<input type='text' name='tekiyou' class='input-xxlarge' maxlength='60' value='${su:htmlEscape(tekiyou)}'>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>摘要コード</label>
						<div class='controls'>
							<input type='text' name='tekiyouCd' class='input-medium' maxlength='4' value='${su:htmlEscape(tekiyouCd)}'>
						</div>
					</div>
					<div class='control-group'>
					...
					<div class='control-group'>
						<label class='control-label'>貸方　ユニバーサルフィールド１</label>
						<div class='controls'>
							<input type='text' name='kashiUf1Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kashiUf1Cd)}'>
							<input type='text' name="kashiUf1Name" class='input-xlarge' disabled value='${su:htmlEscape(kashiUf1Name)}' <c:if test='${"0" eq hfUfSeigyo.uf1ShiyouFlg or "1" eq hfUfSeigyo.uf1ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kashiUf1SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf1ShiyouFlg or "1" eq hfUfSeigyo.uf1ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>貸方　ユニバーサルフィールド２</label>
						<div class='controls'>
							<input type='text' name='kashiUf2Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kashiUf2Cd)}'>
							<input type='text' name="kashiUf2Name" class='input-xlarge' disabled value='${su:htmlEscape(kashiUf2Name)}' <c:if test='${"0" eq hfUfSeigyo.uf2ShiyouFlg or "1" eq hfUfSeigyo.uf2ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kashiUf2SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf2ShiyouFlg or "1" eq hfUfSeigyo.uf2ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
						<label class='control-label'>貸方　ユニバーサルフィールド３</label>
						<div class='controls'>
							<input type='text' name='kashiUf3Cd' class='input-xlarge' maxlength='20' value='${su:htmlEscape(kashiUf3Cd)}'>
							<input type='text' name="kashiUf3Name" class='input-xlarge' disabled value='${su:htmlEscape(kashiUf3Name)}' <c:if test='${"0" eq hfUfSeigyo.uf3ShiyouFlg or "1" eq hfUfSeigyo.uf3ShiyouFlg}'>style='display:none;'</c:if>>
							<button type='button' id='kashiUf3SentakuButton' class='btn btn-small'<c:if test='${"0" eq hfUfSeigyo.uf3ShiyouFlg or "1" eq hfUfSeigyo.uf3ShiyouFlg}'>disabled</c:if> >選択</button>
						</div>
					</div>
					<div class='control-group'>
					...
					<div class='control-group'>
						<label class='control-label'>店券フラグ</label>
						<div class='controls'>
							<input type='text' name='tenkenFlg' class='input-small' maxlength='1' value='${su:htmlEscape(tenkenFlg)}'>
						</div>
					</div>
					<div class='control-group'>
...
function buttonPush(obj){
	...
	switch (obj) {
	case 'koushin':
		formObject.action = 'shiwake_data_de3_henkou_koushin';
		if(window.confirm('変更してもよろしいですか？')){
			$(formObject).submit();
		}
		break;
	case 'shiwakeTaishougai':
		formObject.action = 'shiwake_data_de3_henkou_shiwake_taishougai_koushin';
