...
-- ※Ver 18.10.05.04からのパッチだと単純に追加カラム(シリアライズ)がブランクになればよいが、
-- 　Ver 18.07.28.08→Ver 18.07.29.09/10を経てVer 18.10.05.00/01/02/03/04/05とアップデートした時に追加カラム(シリアライズ)がブランクになってしまわないように特殊なことをやっている。
