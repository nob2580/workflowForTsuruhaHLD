...
if "%ZAIMUVER%" EQU "SIAS" (
    ...
    copy /Y .\files\csv\master_kanri_hansuu_sias_patch.csv	.\files\csv\master_kanri_hansuu_tmp_patch.csv
    copy /Y .\files\csv\master_kanri_ichiran_sias_patch.csv	.\files\csv\master_kanri_ichiran_tmp_patch.csv
) else if "%ZAIMUVER%" EQU "de3" (
    copy /Y .\files\csv\setting_info_de3.csv				.\files\csv\setting_info_tmp.csv
    copy /Y .\files\csv\master_kanri_hansuu_de3_patch.csv	.\files\csv\master_kanri_hansuu_tmp_patch.csv
    copy /Y .\files\csv\master_kanri_ichiran_de3_patch.csv	.\files\csv\master_kanri_ichiran_tmp_patch.csv
) else (
    echo バージョン判別でエラー
    exit /b 1
)
...
del .\files\csv\master_kanri_hansuu_tmp_patch.csv
del .\files\csv\master_kanri_ichiran_tmp_patch.csv
exit /b 0
