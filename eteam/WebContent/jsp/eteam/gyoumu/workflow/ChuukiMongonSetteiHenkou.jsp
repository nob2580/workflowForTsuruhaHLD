...
<html lang='ja'>
	<head>
		<meta charset='utf-8'>
		<title>最終承認者・注記文言設定変更｜<%=EteamSymbol.SYSTEM_NAME%></title>
	...
	<body>
    	<div id='wrap'>
			...
			<div id='content' class='container'>
				...
				<!-- メイン -->
				<div id='main'>
					<form id='myForm' method='post' action='chuuki_mongon_settei_tsuika_henkou' class='form-horizontal'>
					<div>
 ...
 */
 function eventBtn(eventName) {
	...
	switch (eventName) {
	case 'update':
		formObject.action = 'chuuki_mongon_settei_henkou_koushin';
		$(formObject).submit();
		break;
	case 'delete':
		formObject.action = 'chuuki_mongon_settei_henkou_sakujo';
		if(window.confirm('削除してもよろしいですか？')) {
			$(formObject).submit();
		}
		break;
	default:
		formObject.action = 'chuuki_mongon_settei_ichiran';
		$(formObject).submit();
	}
}
		</script>
