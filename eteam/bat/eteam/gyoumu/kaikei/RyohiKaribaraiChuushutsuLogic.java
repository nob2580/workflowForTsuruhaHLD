 ...
 * 旅費仮払抽出ロジック
 */
public class RyohiKaribaraiChuushutsuLogic extends EteamAbstractLogic  {
	...
	public GMap findDenpyou(String denpyouId) {
		String sql =
				"SELECT * "
			+ "FROM denpyou d "
			+ "INNER JOIN ryohi_karibarai k ON "
	...
	public List<GMap> loadDenpyou() {
		...
		return connection.load(sql, DENPYOU_KBN.RYOHI_KARIBARAI_SHINSEI, DENPYOU_JYOUTAI.SYOUNIN_ZUMI);
	}
}