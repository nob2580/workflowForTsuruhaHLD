 ...
 * 仮払抽出ロジック
 */
public class KaribaraiChuushutsuLogic extends EteamAbstractLogic  {
	...
	public List<GMap> loadDenpyou() {
		...
		return connection.load(sql, DENPYOU_KBN.KARIBARAI_SHINSEI, DENPYOU_JYOUTAI.SYOUNIN_ZUMI);
	}
}