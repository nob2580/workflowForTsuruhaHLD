...
/**
 * 届出ジェネレータ項目チェックボックスDTO
 * This code was generated by the tool.
 * This code can not be changed.
 * @author CodeGenerator
 */
@Getter @Setter @ToString
public class KaniTodokeCheckbox implements IEteamDTO {

	/**
	 * default constructor
	 */
	public KaniTodokeCheckbox() {}

	 /**
	 * GMapからDTOを生成
	 * @param m GMap
	 */
	public KaniTodokeCheckbox(GMap m) {
		...
		this.checkboxLabelName = m.get("checkbox_label_name");
	...
	/** チェックボックスラベル名 */
	public String checkboxLabelName;
