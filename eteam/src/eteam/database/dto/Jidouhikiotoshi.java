...
public class Jidouhikiotoshi implements IEteamDTO {

	/**
	 * default constructor
	 */
	public Jidouhikiotoshi() {}

	 /**
	 * GMapからDTOを生成
	 * @param m GMap
	 */
	public Jidouhikiotoshi(GMap m) {
		this.denpyouId = m.get("denpyou_id");
		this.keijoubi = m.get("keijoubi");
		this.hikiotoshibi = m.get("hikiotoshibi");
