...
public class Tsuukinteiki implements IEteamDTO {
	 ...
	 * @param m GMap
	 */
	public Tsuukinteiki(GMap m) {
		this.denpyouId = m.get("denpyou_id");
		this.shiyouKikanKbn = m.get("shiyou_kikan_kbn");
		this.shiyouKaishibi = m.get("shiyou_kaishibi");
		this.shiyouShuuryoubi = m.get("shiyou_shuuryoubi");
		this.jyoushaKukan = m.get("jyousha_kukan");
		this.teikiSerializeData = m.get("teiki_serialize_data");
		...
		this.tenyuuryokuFlg = m.get("tenyuuryoku_flg");
	...
	/** 乗車区間 */
	public String jyoushaKukan;

	/** 定期区間シリアライズデータ */
	public String teikiSerializeData;
