 ...
 * 海外旅費仮払精算Logic
 */
public class KaigaiRyohiKaribaraiShinseiLogic extends EteamAbstractLogic {
	 ...
	 * @param sashihikiHeishuCdKaigai   差引幣種（海外）
	 * @param sashihikiRateKaigai       差引レート（海外）
	 * @param sashihikiTankaKaigaiGaika 差引外貨（海外）
	...
	public int insertShinsei(
		...
		return connection.update(
			...
			kariKamokuCd, kariKamokuName, kariKamokuEdabanCd, kariKamokuEdabanName, kariKazeiKbn, kashiFutanBumonCd, kashiFutanBumonName, kashiKamokuCd, kashiKamokuName, kashiKamokuEdabanCd, kashiKamokuEdabanName, kashiKazeiKbn, 
	...
	public int updateShinsei(
		...
		final String sql =
			...
			+ "SET karibarai_on = ?, user_id = ?, shain_no = ?, user_sei = ?, user_mei = ?, houmonsaki = ?, mokuteki = ?, seisankikan_from = ?, seisankikan_from_hour = ?, seisankikan_from_min = ?, seisankikan_to = ?, seisankikan_to_hour = ?, seisankikan_to_min = ?, shiharaibi = ?, shiharaikiboubi = ?, shiharaihouhou = ?, tekiyou = ?, kingaku = ?, karibarai_kingaku = ?, "
			...
			+ "hosoku = ?, shiwake_edano=?, torihiki_name = ?, kari_futan_bumon_cd = ?, kari_futan_bumon_name = ?, torihikisaki_cd = ?, torihikisaki_name_ryakushiki = ?, kari_kamoku_cd = ?, kari_kamoku_name = ?, kari_kamoku_edaban_cd = ?, kari_kamoku_edaban_name = ?, kari_kazei_kbn = ?, kashi_futan_bumon_cd = ?, kashi_futan_bumon_name = ?, kashi_kamoku_cd = ?, kashi_kamoku_name = ?, kashi_kamoku_edaban_cd = ?, kashi_kamoku_edaban_name = ?, kashi_kazei_kbn = ?, "
			+ "uf1_cd = ?, uf1_name_ryakushiki = ?, uf2_cd = ?, uf2_name_ryakushiki = ?, uf3_cd = ?, uf3_name_ryakushiki = ?, uf4_cd = ?, uf4_name_ryakushiki = ?, uf5_cd = ?, uf5_name_ryakushiki = ?, uf6_cd = ?, uf6_name_ryakushiki = ?, uf7_cd = ?, uf7_name_ryakushiki = ?, uf8_cd = ?, uf8_name_ryakushiki = ?, uf9_cd = ?, uf9_name_ryakushiki = ?, uf10_cd = ?, uf10_name_ryakushiki = ?, "
		...
		return connection.update(
			sql,
			karibaraiOn, siyousha_userId, siyousha_shainNo, siyousha_userSei, siyousha_userMei, houmonsaki, mokuteki, seisankikanFrom, seisankikanFromHour, seisankikanFromMin, seisankikanTo, seisankikanToHour, seisankikanToMin, shiharaibi, shiharaiKiboubi, shiharaihouhou, tekiyou, shinseiKingaku, karibaraiKingaku, 
			sashihikiNum, sashihikiTanka, sashihikiNumKaigai, sashihikiTankaKaigai, sashihikiHeishuCdKaigai, sashihikiRateKaigai, sashihikiTankaKaigaiGaika, hf1Cd, hf1Name, hf2Cd, hf2Name, hf3Cd, hf3Name, hf4Cd, hf4Name, hf5Cd, hf5Name, hf6Cd, hf6Name, hf7Cd, hf7Name, hf8Cd, hf8Name, hf9Cd, hf9Name, hf10Cd, hf10Name,
	...
	public int deleteKeihiMeisai(String denpyouId) {
		final String sql =
				"DELETE FROM kaigai_ryohi_karibarai_keihi_meisai "
			+ "WHERE denpyou_id = ?";
