 ...
 * 旅費精算Logic
 */
public class RyohiSeisanLogic extends EteamAbstractLogic {
	...
	public int insertKeihiMeisai(
		...
		return connection.update(
			sql,
			denpyouId, denpyouEdano, shiwakeEdano, shiyoubi, shouhyouShoruiFlg, torihikiName, tekiyou, zeiritsu, keigenZeiritsuKbn, shiharaiKingaku, hontaiKingaku, shouhizeigaku, houjinCardRiyouFlg, kaishaTehaiFlg, kousaihiShousaiHyoujiFlg, ninzuuRiyouFlg, kousaihiShousai, kousaihiNinzuu, kousaihiHitoriKingaku, kariFutanBumonCd, kariFutanBumonName, torihikisakiCd, torihikisakiNameRyakushiki, kariKamokuCd, kariKamokuName, kariKamokuEdabanCd, kariKamokuEdabanName, kariKazeiKbn, kashiFutanBumonCd, kashiFutanBumonName, kashiKamokuCd, kashiKamokuName, kashiKamokuEdabanCd, kashiKamokuEdabanName, kashiKazeiKbn, uf1Cd, uf1NameRyakushiki, uf2Cd, uf2NameRyakushiki, uf3Cd, uf3NameRyakushiki,uf4Cd, uf4NameRyakushiki, uf5Cd, uf5NameRyakushiki, uf6Cd, uf6NameRyakushiki, uf7Cd, uf7NameRyakushiki, uf8Cd, uf8NameRyakushiki, uf9Cd, uf9NameRyakushiki, uf10Cd, uf10NameRyakushiki,
	...
	public int deleteKeihiMeisai(String denpyouId) {
		final String sql =
				"DELETE FROM ryohiseisan_keihi_meisai "
			+ "WHERE denpyou_id = ?";
